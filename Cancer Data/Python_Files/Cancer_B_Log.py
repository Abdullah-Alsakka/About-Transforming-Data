...
"""
print()
print("The semi-log model for dilute cancer cell growth.")
...
#open data file
with open("log_Cancer_series_B.csv","r") as i:
...
p0=[3.0,0.01] #The first value is the log(voltage) guess, the second value for the guess for resistivity.
...
fig.savefig("LogCancerGrowth_vs_time.eps", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
