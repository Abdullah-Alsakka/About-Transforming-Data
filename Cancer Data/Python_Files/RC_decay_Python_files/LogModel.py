...
#open data file
"""
with open("Log_Volt.csv","r") as i:
    rawdata = list(csv.reader(i, delimiter = ","))
RCdata = np.array(rawdata[1:],dtype=float)
xdata = RCdata[:,1]
ydata = RCdata[:,2]
error = RCdata[:,3]    
        
"""
with open("Log_Volt_vers2.csv","r") as i:
    rawdata = list(csv.reader(i, delimiter = ","))
...
p0=[3.0,2.0] #The first value is the voltage guess, the second value for the guess for resistivity.
