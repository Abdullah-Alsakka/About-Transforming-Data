...
The distance mag values are plotted vs. the redshift, z. This variation of the Einstein-Newcomb-
Desitter model has two parameters: Hubble constant, Hu, normalised matter density, \u03A9m; in 
a universe with flat geometry. This model is reviewed in Yershov, V.N. 2023, Universe, vol. 9(5), 204.
...
# normalised chisquar is calculated for 1702 data pairs (N) with P the parameter count (2) as
P=2
N=1702
e=2.71828183
