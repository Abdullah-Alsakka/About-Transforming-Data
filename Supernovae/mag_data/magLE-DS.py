...
print(" two parameters, the Hubble constant, Hu and the normalised spacetime density, \u03A9k, ") 
print(" presumed to be small. The value of the normalised contribution from the ")
...
#and b (Hubble constant) and c (space density) are the parameters to be estimated
def func(x,b,c):
