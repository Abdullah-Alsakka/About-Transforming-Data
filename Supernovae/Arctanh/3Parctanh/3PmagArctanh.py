...
print()
print("This is the 3PmagArctanh model. The correlation is distance mag (\mu) vs. ") 
print("redshift (z) with sinn(x) = sinh(x) modelling elliptical space geometry.")
print()
...
# evaluate the function with the parameter estimates
func2data = func2(xdata,ans_b,ans_c,ans_d)
...
fig.savefig("3PmagArctanh.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("3PmagArctanh.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
