...
fig.savefig("D_L_Lambda_E-DS.eps", format="eps", dpi=1200, bbox_inches="tight", transparent=True)
fig.savefig("D_L_Lambda_E-DS.pdf", format="pdf", dpi=1200, bbox_inches="tight", transparent=True)
