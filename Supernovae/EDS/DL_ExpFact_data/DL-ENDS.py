...
in a universe with Euclidean geometry. This model is reviewed in Yershov, V.N. 2023, Universe, 
...
print("This is the D_L_ENdS model, a version of the Einstein-Newcomb-DeSitter model of cosmology.")
