...
fig.savefig("mag_Rh.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("mag_Rh.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
