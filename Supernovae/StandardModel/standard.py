...
This variation of the standard (LCDM) model has two parameters: Hubble constant, Hu, 
...
model of cosmology, Riess et al. and previous articles.
"""
print()
...
#enablining the correlation of distance mag with redshift, z, data
def func3(x,Hu,O_m):
...
fig.savefig("Standard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("Standard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
