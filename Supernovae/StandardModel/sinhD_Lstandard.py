...
The standard (LCDM) model used here with sinn(x) = sinh(x). This model requires 
numerical integration with two parameters, the Hubble constant, Hu and the 
...
fig.savefig("sinhD_Lstandard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("sinhD_Lstandard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
