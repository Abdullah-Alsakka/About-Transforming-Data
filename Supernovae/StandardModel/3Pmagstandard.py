...
matter density, O_m; the cosmological constant, O_L, with O_k = 1-O_m-O_L as the remainder of 
...
print("The correlation is distance mag vs. redshift, z, with sinn(x) = x for Euclidean geometry")
...
# for use with the distance mag vs. redshift, z, data
...
# guess for the Hubble constant, Hu. No need to input numbers for the initial guesses but 
#use the normalized matter density, O_m, and dark energy, O_L estimates.
