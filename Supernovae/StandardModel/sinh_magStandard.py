...
print()
print("This is the magStandard model of cosmology, but using sinn(x) = sinh(x).")
print()
# open data file
...
fig.savefig("sinh_magStandard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("sinh_magStandard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
