...
print()
print("This is the sinhmagStandard model of cosmology, using sinn(x) = sinh(x).")
print()
# open data file
...
# normalised chisquar is calculated for 1701 data pairs, P the parameter count (2)
P=2
N=1701
e=2.71828183
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "green", label = "sinh_magStandard model")
...
fig.savefig("sinhmagStandard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("sinhmagStandard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
