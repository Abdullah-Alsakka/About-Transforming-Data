...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "green", label = "sin_magStandard model")
...
fig.savefig("sin_magStandard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("sin_magStandard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
