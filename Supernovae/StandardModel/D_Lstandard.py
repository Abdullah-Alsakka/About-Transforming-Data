...
fig.savefig("D_L_standard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("D_L_standard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)