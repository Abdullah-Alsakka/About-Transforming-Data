...
"""
print()
print("This is the 3PsinhmagStandard model, typically known as the standard model of cosmology.")
print("The correlation is distance mag vs. redshift, z, with sinn(x) = sinh(x) describing quasi-Euclidean geometry.")
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m,ans_O_L), color = "green", label = "3PsinhmagStandard model")
