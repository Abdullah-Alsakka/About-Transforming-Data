...
init_guess = np.array([70,.35,0.60])
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m,ans_O_k), color = "green", label = "sinh_3PmagStandard model")
...
fig.savefig("3PmagStandard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
