...
The standard (O_L, LCDM) model used here requires numerical integration with two parameters, 
...
#Model function
O_m = 0.30 #initial guess for matter density, 1-O_m is used to represent the nomalised cosmological constant.
...
e = 2.718281
"""
#calculate the statistical fitness in the common manner
