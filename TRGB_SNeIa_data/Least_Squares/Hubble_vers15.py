...
"""
print()
print("This curve_fit regression routine of Python scipy, uses the 'distance mag' data, converted to luminosity distances, D_L, vs redshift. Data from Brout et al. 2022, 'The Pantheon+ Analysis: Cosmological Constraints' Astrophys. J. vol. 938, 110 and W. Freedman et al. 2019 The Carnegie-Chicago Hubble Program. VIII. ApJ vol. 882, 34. Here we use the Hubble model with only a single parameter, the Hubble constant; no values are calculated for matter density, dark energy or space geometry. The Python 3 least_squares robust regression routine is employed with the specification that the routine specifies loss='cauchy' or 'linear'.")
