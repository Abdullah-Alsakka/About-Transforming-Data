...
Astrophys. J. vol. 938, 110 AND the TRGB data, from GS Anand et al. 2022, 'Comparing Tip of the Red Giant 
Branch Distance Scales:' Astrophys. J. vol. 932, 15. The model selected is the E-DS (from Oeztas et al. Int J Theor Phys 2008). 
...
# calculate the statistical fitness, using N=1717 as the number of data pairs and P=1 as the parameter count
P=1
N=1717
e = 2.718281
