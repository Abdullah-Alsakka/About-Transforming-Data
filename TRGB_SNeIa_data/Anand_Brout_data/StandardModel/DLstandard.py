...
'The Pantheon+ Analysis: Cosmological Constraints' Astrophys. J. vol. 938, 110 AND 
the TRGB data, from GS Anand et al. 2022, 'Comparing Tip of the Red Giant Branch Distance Scales:' 
Astrophys. J. vol. 932, 15. The standard (LCDM) model used here requires numerical integration 
with two parameters, the Hubble constant, Hu and the normalised matter density, O_m with 
presumed Euclidean space geometry, that is sinn(x) = x. An estimate of the normalized cosmological constant 
...
print("Only 2 parameters can be estimated with this model.")
