...
model of cosmology, Riess et al. 2004, ApJ, vol. 607, p. 665-687 and Riess et al. 2022, ApJ Lett, vol. 934, p. L7.
"""
print()
print("This is the current standard model presuming Euclidean space geometry, with")
print("two free parameters and sinn(x) = x.")
...
# open data file
with open("Brout_DATAB.csv","r") as i:
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "green", label = "Standard model SNe Ia data")
