...
Scales: 'Astrophys. J. vol. 932, 15. This variation of the standard (\Omega_{\Lambda} LCDM) 
...
# open data file
with open("Brout_DATA.csv","r") as i:
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "green", label = "$D_L$Standard model SNe Ia data")
