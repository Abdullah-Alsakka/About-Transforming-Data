...
"""
print()
print("This is the sinhmag3PStandard model, typically known as the standard model of cosmology.")
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m,ans_O_L), color = "green", label = "sinhmag3PStandard model")
