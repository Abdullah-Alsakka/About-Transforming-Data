...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m,ans_O_L), color = "orange", label = "sinh$D_L$3PStandard model")
...
fig.savefig("sinhDL3PStandard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("sinhDL3PStandard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)