...
fig.savefig("mag2PArctanhDEMO.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("mag2PArctanhDEMO.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
