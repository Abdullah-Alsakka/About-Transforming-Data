...
This curve_fit regression routine of Python scipy, uses the 18 TRGB data, 
converted to luminosity distances, D_L, vs. cz, from Freedman et al. 2019, 
...
ApJ vol. 938, 110 OR the 16 TRGB data from Anand et al. 2022,  
'Comparing Tip of the Red Giant Branch Distance Scales: An Independent 
Reduction of the Carnegie-Chicago Hubble Program and the Value of the 
Hubble Constant' ApJ vol. 932, 15. This model is the simplest solution 
with two parameters, the Hubble constant, Hu, and the intercept. 
Estimates of matter or dark energy are not possible.
"""
print()
print("This is THE Hubble correlation, a version of cosmology. It is not possible" )
...
#open data file
#with open("TRGB_data_ANAND_2022.csv","r") as i:
...
fig.savefig("HubbleAnand.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("HubbleAnand.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
