...
print(" vol. 38, 110. This is the solution to the Einstein-de Sitter model with ")
...
func2data = func(xdata,ans_b,ans_c)
...
plt.plot(xdata, func2data, color = "green", label = "$D_L$\u039BE-DS model")
...
fig.savefig("DL_LE-DS.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("DL_LE-DS.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
