...
"""
print()
print("This is our magENDS model, a version of the Einstein-De Sitter model of cosmology.")
print("It is not possible to estimate the value for \u03A9k with this model.")
