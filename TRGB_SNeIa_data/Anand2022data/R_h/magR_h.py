...
from Brout et al. 2022, 'The Pantheon+ Analysis: Cosmological Constraints' ApJ. vol. 938, 110 AND 
the 15 TRGB data, from GS Anand et al. 2022, 'Comparing Tip of the Red Giant Branch Distance Scales:' 
ApJ. vol. 932, 15. The model selected is the Melia 2012 solution, not formally the Freidmann-Lemaitre-
Robertson-Walker (FLRW) model. This model presents only one parameter, the Hubble constant. 
No estimation is possible for either the normalized matter density, which is 
presumed to be about 1, nor dark energy.")
"""
print()
print("This is the R_h modeled using luminosity distances, distance mag, vs. the redshift z")
