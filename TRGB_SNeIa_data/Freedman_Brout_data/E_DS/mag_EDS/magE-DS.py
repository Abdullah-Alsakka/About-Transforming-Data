...
Branch Distance Scales:' Astrophys. J. vol. 932, 15. The model selected is the Einstein-deSitter solution, not the FLRW model. This model presents 
...
plt.ylabel("$\mu$ (5*log$_{10}$(distance)+25)", fontsize=16)
