...
110 AND the TRGB data, from GS Anand et al. 2022, 'Comparing Tip of the Red Giant Branch Distance Scales: 
'Astrophys. J. vol. 932, 15. The model selected is the Melia 2012 solution,with only one parameter, the Hubble constant. 
