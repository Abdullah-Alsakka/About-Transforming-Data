...
Astrophys. J. vol. 938, 110 AND the 18 TRGB data, from Wendy Freedman et al. 2019, 
'The Carnegie-Chicago Hubble Program. VIII.' ApJ 882, 34. This is the 2 parameter 
Arctanh, analytical solution to the Friedmann-Lemaitre-Roberston-Walker (FLRW) model. 
Only the two parameters, the Hubble constant, Hu and the normalised matter density, 
O_m can be estimated. No estimation is possible for \Omega_L, the normalised cosmological 
constant (dark energy) but O_k, the normalised contribution from space is estimated 
as the remainder.
"""

print()
print("This is the arctanh model using the D_L vs. redshift, z, data.")
...
chisq = sum(((ydata - func(xdata,ans_b,ans_c))**2)/func2(xdata,ans_b,ans_c))
