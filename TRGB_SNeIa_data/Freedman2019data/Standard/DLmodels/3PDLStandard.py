...
1=O_m+O_L+O_k. With O_k as the remainder for spacetime, no presumed space geometry.

"""
print()
print("This is the 3PStandard model, a version of the standard model of cosmology.")
...
# normalised chisquar is calculated for N=1716 data pairs with P the parameter count (3) as
P=3
N=1720
e=2.71828183
