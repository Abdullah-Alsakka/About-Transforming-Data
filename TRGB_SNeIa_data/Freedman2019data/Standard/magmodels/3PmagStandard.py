...
vol. 938, 110 and the TRGB data, from W. Freedman et al. 2019, 'The Carnegie-Chicago Hubble Program. VIII.'
ApJ. vol. 882, 34.. This variation of the LCDM model has three free parameters:the Hubble constant, Hu, 
normalised matter density, O_m; the cosmological constant, O_L, with 1=O_m+O_L+O_k. With O_k as the information remainder.
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m,ans_O_L), color = "green", label = "3PmagStandard model")
