...
"""
print()
print("The matter density is presumed to be about 1, the values for dark energy and space geometry cannot be estimated.")
print()
...
newxsqrd = sum(((ydata - func(xdata,Hubble))**2)/error**2)
...
fig.savefig("DL_E-DS.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("DL_E-DS.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
