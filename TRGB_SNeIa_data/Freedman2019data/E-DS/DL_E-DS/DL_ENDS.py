...
AND the TRGB data, from GS Anand et al. 2022, 'Comparing Tip of the Red Giant Branch Distance Scales:'
Astrophys. J. vol. 932, 15. The distance mag values are plotted vs. the redshift, z.
This variation of the Einstein-Newcomb-Desitter model has two parameters: Hubble constant,
Hu, normalised matter density, \u03A9m; in a universe with flat geometry. This model 
