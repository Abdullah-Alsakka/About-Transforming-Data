...
O_L = 0.10 #initial guess for Omega_k
...
init_guess = np.array([65,0.30,0.65])
...
#Rans_O_k_SD = round((1-Rans_O_m_SD - Rans_O_L_SD)/2 ,4)
...
normchisquar = round((chisquar/(N-P)),2)
"""
# normalised chisquar where P is the number of parameters (3), N= number of data pairs 
P=3
N=157
...
print("The calculated O_m with S.D. is: ", Rans_O_m,",",Rans_O_m_SD)
