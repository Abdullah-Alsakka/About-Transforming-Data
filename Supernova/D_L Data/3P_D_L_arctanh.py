...
"""
print()
print("This Python 3, scipy curve_fit regression routine uses the SNe Ia data, as D_L vs expansion factor, calculated using the gold data set from Riess, A.G. et al. Type Ia Supernova Discoveries at z> 1 from the Hubble Space Telescope: Evidence for Past Deceleration and Constraints on Dark Energy Evolution. Astrophys. J. 607(2), 665-687 (2004). The model selected here is the arctanh analytical solution with three parameters, the Hubble constant, Hu, the normalised matter density, O_m, and the spacetime parameter, O_k. No estimate of dark energy is possible.")
...
bnds = ([50.0, 0.0001, 0.001],[80.0, 1.0, 1.0])
...
rans_d_SD = round(ans_d_SD,4)

# normalised chisquar where P is the number of parameters (3), N is the number of data pairs 
P=3
N=157
