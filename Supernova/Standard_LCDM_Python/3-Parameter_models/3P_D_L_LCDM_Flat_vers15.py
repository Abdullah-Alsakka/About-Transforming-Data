...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m,ans_O_L), color = "orange", label = "3P $\Lambda$CDM model, sinh=1")
...
fig.savefig("3Param_LCDM_Flat_D_L_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("3Param_LCDM_Flat_D_L_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
