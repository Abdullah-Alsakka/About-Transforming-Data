...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "orange", label = "flat sinh $\Lambda$CDM model")
...
fig.savefig("flat_sinh_LCDM_D_L_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("flat_sinh_LCDM_D_L_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)