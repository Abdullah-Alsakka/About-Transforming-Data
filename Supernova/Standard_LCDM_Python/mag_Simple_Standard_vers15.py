...
This model is outlined in sections 2.5.4, 3.3 and equations 11, 12, 13, 14 and Appendix B2 of the manuscript.
@author: Mike
"""
...
fig.savefig("standard_mag_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("standard_mag_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
