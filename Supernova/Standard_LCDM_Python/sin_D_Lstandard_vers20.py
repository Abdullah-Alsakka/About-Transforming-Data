...
def func3(x,Hu,O_m):
    return (litesped/(x*Hu))*np.sin((func2(x,O_m)))
...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "orange", label = "sin $D_L$standard model")
...
fig.savefig("sin_D_L_standard.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("sin_D_L_standard.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)