...
chisq = sum((ydata - func2(xdata,ans_b,ans_c))**2/(error**2))
...
#plt.title("Arctan model with mag vs. redshift z", fontsize = 18)
plt.plot(xdata, func2(xdata,ans_b,ans_c), color = "orange", label = "Arctanh model")
...
# fig.savefig("ArctanModel_mag_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
# fig.savefig("ArctanModel_mag_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
