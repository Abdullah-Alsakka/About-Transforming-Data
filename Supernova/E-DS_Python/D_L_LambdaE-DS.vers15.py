...
This code solves equation A26 of Appendix, section A3.2, E-DS universe with \Omega_m=0 and \Omega_{\Lambda}>0.
@author: Mike
"""
print()
print("This curve_fit regression routine of Python scipy, uses the 'distance mag' data, converted to luminosity distances, D_L, vs expansion factor, \u03BE, from Brout et al. 2022, 'The Pantheon+ Analysis: Cosmological Constraints' Astrophys. J. vol. 938, 110. The model selected here is a version of the arctanh analytical solution with two parameters, the Hubble constant and the normalised spacetime density, \u03A9k. No estimate of matter density is possible (which might be assumed to be 0?).")
print()
...
plt.plot(xdata, funcdata, color = "orange", label = "\u039BE-DS Model")
...
print("Since this model presumes that \u03A9m=0, \u03A9\u039B is calculated to be ",rans_L )
print()
