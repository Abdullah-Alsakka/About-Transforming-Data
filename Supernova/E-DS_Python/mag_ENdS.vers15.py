...
This code solves equation A27 of Appendix, section A3.2, E-DS universe with \Omega_m=0 and \Omega_{\Lambda}>0. Use of equation A29 with distance mag and redshift data.
@author: Mike
"""
