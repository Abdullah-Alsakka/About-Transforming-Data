...
density, which is presumed to be about 0, nor dark energy nor space geometry.")
"""
print()
print("The matter density is presumed to be about 0 and values for dark energy and space geometry cannot be estimated.")
print()
...
#P=1 as the degree of freedom (parameter count)
P=1
N=1701
e = 2.718281
...
#Calculate the chi^2 in the common manner
