...
This code solves equation 5 of section 2.5.1, Einstein-DeSitter model, and A22, A23 of the Appendix.
@author: mike
"""
print()
print("This curve_fit regression routine of Python scipy, uses the data, as luminosity distance vs recession velocity (\u03BE,  1/1+z), from Brout et al. 2022, 'The Pantheon+ Analysis: Cosmological Constraints' Astrophys. J. vol. 938, 110. The model selected is the E-DS (from Oeztas, Smith, Paul, 2008) This model presents only one parameter, the Hubble constant. No estimation is possible for either the normalized matter density, which is presumed to be about 0, nor dark energy nor space density.")
print()
...
plt.plot(xdata, funcdata, color = "green", label = "$D_L$E-DS model")
...
fig.savefig("D_L_E-DS.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
