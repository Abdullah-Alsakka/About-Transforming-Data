...
#plt.title("E-DS Model with $D_L$ vs. Expansion factor", fontsize = 18)
...
# fig.savefig("EinsteinDeSitterModel_D_L_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
# fig.savefig("EinsteinDeSitterModel_D_L_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
