...
plt.xlabel("Expansion factor", fontsize = 16)
plt.ylabel("Luminosity distance (Mpc)", fontsize = 16)
#plt.title("Arctanh model, $D_L$ vs. Exp. fact.", fontsize = 18)
plt.plot(xdata, funcdata, color = "orange", label = "Analytical model")
...
# fig.savefig("ArctanModel_D_L_data.eps", format="eps", dpi=1200, bbox_inches="tight", transparent=True)
# fig.savefig("ArctanModel_D_L_data.pdf", format="pdf", dpi=1200, bbox_inches="tight", transparent=True)
