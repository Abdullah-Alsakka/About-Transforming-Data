...
plt.plot(xdata, func3(xdata,ans_Hu,ans_O_m), color = "orange", label = "Flat LCDM model")
...
# fig.savefig("FlatCDM_Model_D_L_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
# fig.savefig("FlatCDM_Model_D_L_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
