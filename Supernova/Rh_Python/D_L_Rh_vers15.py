...
fig.savefig("Rh_D_L_data.eps", format="eps", dpi=2000, bbox_inches="tight", transparent=True)
fig.savefig("Rh_D_L_data.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
