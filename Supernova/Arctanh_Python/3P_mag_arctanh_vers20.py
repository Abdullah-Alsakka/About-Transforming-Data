...
print()
print("This is the 3PmagArctanh model. The correlation is distance mag vs. redshift, z, ","with sinn(x) = sinh(x) for elliptical space geometry.",os.linesep)
...
plt.plot(xdata, func2(xdata,ans_b,ans_c,ans_d), color = "green", label = "3P-magArctanh model")
...
fig.savefig("3P_mag_Arctanh.pdf", format="pdf", dpi=2000, bbox_inches="tight", transparent=True)
