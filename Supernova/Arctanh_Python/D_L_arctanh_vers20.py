...
No estimate of dark energy is possible.
"""
print()
...
fig.savefig("D_L_arctanh.eps", format="eps", dpi=1200, bbox_inches="tight", transparent=True)
fig.savefig("D_L_arctanh.pdf", format="pdf", dpi=1200, bbox_inches="tight", transparent=True)
